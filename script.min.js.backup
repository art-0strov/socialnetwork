...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function getCurrentScrollableElement() {
    ...
    if (!feedElement.hidden) return feedElement;
    if (searchElement && !searchElement.closest('.page').hidden) return searchElement;
    if (notificationsElement && !notificationsElement.closest('.page').hidden) return notificationsElement;
    if (accountElement && !accountElement.closest('.page').hidden) return accountElement;
