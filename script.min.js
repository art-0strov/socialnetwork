...
// Контейнер для превью фото в десктопной версии
let desktopImagePreview = null;
...
// Создаем контейнер для превью фото в десктопной версии
function createDesktopImagePreview() {
  ...
  // Вставляем контейнер превью после поля ввода, перед футером
  ...
  desktopImagePreview = previewImage;
  ...
  postImageInput.addEventListener('change', function(e) {
    ...
    if (file) {
      ...
      reader.onload = function(event) {
        desktopImagePreview.src = event.target.result;
  ...
  removePreviewBtn.addEventListener('click', function(e) {
    ...
    removePreviewBtn.style.display = 'none'; // Скрываем кнопку крестика
  });
}
...
if (mobileCreatePostBtn && mobileCreatePostModal) {
  ...
  if (mobilePostImageInput) {
    ...
    const mobileCreatePostFooter = document.querySelector('.mobile-create-post-footer');
    if (mobilePostInputContainer && mobileCreatePostFooter) {
      mobileCreatePostFooter.before(previewContainer);
    }
